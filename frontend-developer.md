...
Estamos buscando un perfil de **Desarrollador Frontend Web React**, para unirse a nuestro equipo técnico. Formarás parte activa del desarrollo de los distintos productos que forman nuestra plataforma de telemedicina.
...
- Demostrarás tu conocimiento en applicaciones Frontend para ayudar al resto del equipo.
...
- Que domines y tengas experiencia trabajando con Javascript, Typescript y React como framework principal.
- Que sepas trabajar con HTML5 y CSS3. También frameworks CSS como Tailwind.
- Que tengas experiencia como Frontend Engineer de 4 años al menos.
